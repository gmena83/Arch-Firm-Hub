...
export const DOCUMENTS = {
  "proj-1": [
    ...
    },
    {
      ...
      caption: "Hilltop lot facing the Atlantic — pre-clearing reference shot.",
  ...
  "proj-2": [
    ...
    },
    {
      ...
      caption: "Second-floor framing in progress — week 32.",
    ...
    },
    {
      ...
      category: "construction" as const,
      photoCategory: "construction_progress" as const,
      caption: "Pool excavation completed — ready for rebar tie-in.",
    ...
    },
    {
      ...
      category: "construction" as const,
      photoCategory: "site_conditions" as const,
      caption: "Existing slab and access road before mobilization.",
    ...
    },
    {
      ...
      caption: "Master bedroom corner flagged for drywall touch-up — assigned to subcontractor.",
      imageUrl: "https://images.unsplash.com/photo-1581244277943-fe4a9c777189?w=800&auto=format&fit=crop",
      isClientVisible: false,
      uploadedBy: "Carla Gautier",
  ...
  "proj-3": [
    ...
    },
    {
      ...
      category: "client_review" as const,
      photoCategory: "final" as const,
      caption: "Interior seating area with custom millwork — handed over to client.",
    ...
    },
    {
      ...
      category: "construction" as const,
      photoCategory: "site_conditions" as const,
      caption: "Pre-renovation interior — empty shell before scope work began.",
      imageUrl: "https://images.unsplash.com/photo-1504624230544-d24b46d11a99?w=800&auto=format&fit=crop",
      isClientVisible: true,
      uploadedBy: "Jorge Rosa",
